...
public class getStatus {
    ...
    public getStatus(Integer id, Integer invoiceNo, String venicheType, Integer customer, String location, String note, Integer vendor, Integer price, Integer duration, String time, String service, String venichleSeries, String status, Customerdata customerdata, Vendordata vendordata) {
        this.id = id;
